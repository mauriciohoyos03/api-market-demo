...
import com.mauricio.market_demo.domain.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> getProduct(@ApiParam(value = "Id of the product", required = true, example = "5") @PathVariable int productId) {
